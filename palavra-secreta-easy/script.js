...
localStorage.setItem('timeDaVez', timeDaVez);
localStorage.setItem('numTimes', numTimes);
localStorage.setItem('numRodadas', numRodadas);
localStorage.setItem('categoriaAtual', categoriaAtual);

localStorage.setItem('tela-inicio-load', document.querySelector('#tela-inicio-load').style.display);
localStorage.setItem('tela-inicial', document.querySelector('#tela-inicial').style.display);
localStorage.setItem('tela-colocar-nomes', document.querySelector('#tela-colocar-nomes').style.display);

localStorage.setItem('escolher-categoria', document.querySelector('#escolher-categoria').style.display);
localStorage.setItem('categoria-animais', document.querySelector('#categoria-animais').style.display);
localStorage.setItem('categoria-tv-cinema', document.querySelector('#categoria-tv-cinema').style.display);
localStorage.setItem('categoria-objetos', document.querySelector('#categoria-objetos').style.display);
localStorage.setItem('categoria-lugares', document.querySelector('#categoria-lugares').style.display);
localStorage.setItem('categoria-pessoas', document.querySelector('#categoria-pessoas').style.display);
localStorage.setItem('categoria-esportes', document.querySelector('#categoria-esportes').style.display);
localStorage.setItem('categoria-profissao', document.querySelector('#categoria-profissao').style.display);
localStorage.setItem('categoria-alimentos', document.querySelector('#categoria-alimentos').style.display);
localStorage.setItem('categoria-biblico', document.querySelector('#categoria-personagens').style.display);

localStorage.setItem('tela-preparar', document.querySelector('#tela-preparar').style.display);
localStorage.setItem('iniciar-rodada-animais', document.querySelector('#iniciar-rodada-animais').style.display);
localStorage.setItem('iniciar-rodada-tv-cinema', document.querySelector('#iniciar-rodada-tv-cinema').style.display);
localStorage.setItem('iniciar-rodada-objetos', document.querySelector('#iniciar-rodada-objetos').style.display);
localStorage.setItem('iniciar-rodada-lugares', document.querySelector('#iniciar-rodada-lugares').style.display);
localStorage.setItem('iniciar-rodada-pessoas', document.querySelector('#iniciar-rodada-pessoas').style.display);
localStorage.setItem('iniciar-rodada-esportes', document.querySelector('#iniciar-rodada-esportes').style.display);
localStorage.setItem('iniciar-rodada-profissao', document.querySelector('#iniciar-rodada-profissao').style.display);
localStorage.setItem('iniciar-rodada-alimentos', document.querySelector('#iniciar-rodada-alimentos').style.display);
localStorage.setItem('iniciar-rodada-biblico', document.querySelector('#iniciar-rodada-personagens').style.display);

localStorage.setItem('tela-contagem-preparar', document.querySelector('#tela-contagem-preparar').style.display);
}
...
let biblico = ['Abraão', 'Isaque', 'Jacó', 'José do Egito', 'Adão', 'Eva', 'Caim', 'Abel', 'Enoque', 'Noé', 'Ninrode', 'Ló', 'esposa de Ló', 'Rebeca', 'Raquel', 'Sara', 'Diná', 'Jó', 'Moisés', 'Zípora', 'Arão', 'Josué', 'Calebe', 'Balaão', 'Raabe', 'Jericó', 'Jardim do Éden', 'Sodoma e Gomorra', 'Egito', 'Acã', 'Rute', 'Noemi', 'Ester', 'Mordeicai', 'Gideão', 'Jefté', 'Sansão', 'Samuel', 'Saul', 'Davi', 'Golias', 'Abigail', 'Salomão', 'Absalão', 'Jezabel', 'Elias', 'Eliseu', 'Jonas', 'Ezequias', 'Josias', 'Naamã', 'Jeremias', 'Daniel', 'Nabucodonosor', 'Ciro', 'Neemias', 'Anjo Gabriel', 'Maria', 'Belém', 'Herodes', 'João Batista', 'Pilatos', 'Pedro', 'Mateus', 'Malco', 'Judas Iscariotes', 'Lázaro', 'Timóteo', 'Paulo', 'Êutico', 'Zaqueu', 'Babilônia', 'Zacarias', 'Nazaré', 'batismo', 'templo', 'milagre', 'ressureição', 'Armagedom', 'sinagoga', 'Isaías', 'Ezequiel', 'Salmos', 'Provérbios', 'Eclesiastes', 'Apocalipse', 'Gênesis', 'Lucas', 'José de Arimateia', 'oração', 'Ana', 'Corá', 'Miriã', 'Potifar', 'Jonatã', 'Esaú', 'Geazi', 'Marcos', 'dilúvio', 'Espírito Santo', 'anjos', 'querubins', 'serafins', 'sacrifício', 'Metusalém', 'nefilins', 'Torre de Babel', 'Canaã', 'Judá', 'Levi', 'lepra', 'Jeová', 'Jesus', 'Maná', 'Grande Tribulação', 'Dalila', 'Monte Sinai', 'tabernáculo', 'arca do pacto', 'candelabro', 'resgate', 'trindade', 'paraíso', 'geena', 'Moabe', 'Israel', 'Rio Nilo', 'Rio Jordão', 'Jerusalém', 'Acabe', 'Sadraque', 'Mesaque', 'Abdnego', 'Esdras', 'Assuero', 'Hamã', 'Samaria', 'Marta', 'Jairo', 'Filipe', 'Ebede-Meleque', 'Galileia', 'Herodias', 'Sem', 'Cã', 'Jafé', 'Êxodo', 'Levítico', 'Números', 'Deuteronômio', 'Juízes', 'Cântico de Salomão', 'Lamentações', 'Oseias', 'Joel', 'Amós', 'Obadias', 'Miqueias', 'Naum', 'Habacuque', 'Sofonias', 'Ageu', 'Zacarias', 'Malaquias', 'João', 'Atos', 'Romanos', '1 Coríntios', '2 Corintios', 'Gálatas', 'Efésios', 'Filipenses', 'Colossenses', 'Tito', 'Filêmon', 'Hebreus', 'Tiago', 'profecia', 'sacerdote', 'Ur', 'adoração', 'Ananias', 'Labão', 'Bíblia', 'Mar Vermelho', 'Os 10 mandamentos', 'Dorcas', 'Nabal', 'Bate-Seba', 'Urias', 'Natã', 'Assíria', 'viuva de Sarefá', 'pacto', 'Ungido'];
  ...
  //tela inicial, 'novo jogo' ou 'continuar partida'
  document.querySelector('#novo-jogo').onclick = function () {
    document.querySelector('#tela-inicio-load').style.display = 'none';
    document.querySelector('#tela-inicial').style.display = 'block';
    localStorage.clear();
}

document.querySelector('#continuar-partida').onclick = function () {
    times = JSON.parse(localStorage.getItem('times'));
    timeDaVez = localStorage.getItem('timeDaVez');
    numTimes = localStorage.getItem('numTimes');
    numRodadas = localStorage.getItem('numRodadas');
    categoriaAtual = localStorage.getItem('categoriaAtual');

    document.querySelector('#tela-inicio-load').style.display = localStorage.getItem('tela-inicio-load');
    document.querySelector('#tela-inicial').style.display = localStorage.getItem('tela-inicial');
    document.querySelector('#tela-colocar-nomes').style.display = localStorage.getItem('tela-colocar-nomes');

    document.querySelector('#escolher-categoria').style.display = localStorage.getItem('escolher-categoria');
    document.querySelector('#categoria-animais').style.display = localStorage.getItem('categoria-animais');
    document.querySelector('#categoria-tv-cinema').style.display = localStorage.getItem('categoria-tv-cinema');
    document.querySelector('#categoria-objetos').style.display = localStorage.getItem('categoria-objetos');
    document.querySelector('#categoria-lugares').style.display = localStorage.getItem('categoria-lugares');
    document.querySelector('#categoria-pessoas').style.display = localStorage.getItem('categoria-pessoas');
    document.querySelector('#categoria-esportes').style.display = localStorage.getItem('categoria-esportes');
    document.querySelector('#categoria-profissao').style.display = localStorage.getItem('categoria-profissao');
    document.querySelector('#categoria-alimentos').style.display = localStorage.getItem('categoria-alimentos');
    document.querySelector('#categoria-biblico').style.display = localStorage.getItem('categoria-biblico');

    document.querySelector('#tela-preparar').style.display = localStorage.getItem('tela-preparar');
    document.querySelector('#iniciar-rodada-animais').style.display = localStorage.getItem('iniciar-rodada-animais');
    document.querySelector('#iniciar-rodada-tv-cinema').style.display = localStorage.getItem('iniciar-rodada-tv-cinema');
    document.querySelector('#iniciar-rodada-objetos').style.display = localStorage.getItem('iniciar-rodada-objetos');
    document.querySelector('#iniciar-rodada-lugares').style.display = localStorage.getItem('iniciar-rodada-lugares');
    document.querySelector('#iniciar-rodada-pessoas').style.display = localStorage.getItem('iniciar-rodada-pessoas');
    document.querySelector('#iniciar-rodada-esportes').style.display = localStorage.getItem('iniciar-rodada-esportes');
    document.querySelector('#iniciar-rodada-profissao').style.display = localStorage.getItem('iniciar-rodada-profissao');
    document.querySelector('#iniciar-rodada-alimentos').style.display = localStorage.getItem('iniciar-rodada-alimentos');
    document.querySelector('#iniciar-rodada-biblico').style.display = localStorage.getItem('iniciar-rodada-biblico');

    document.querySelector('#tela-contagem-preparar').style.display = localStorage.getItem('tela-contagem-preparar');
}
...
function iniciarRodadaAnimais() {
    ...
    function sortearPalavraAnimais() {
        let numSorteio = Math.ceil(Math.random() * animais.length);
...
function iniciarRodadaObjetos() {
    ...
    function sortearPalavraObjetos() {
        let numSorteio = Math.ceil(Math.random() * objetos.length);
...
function iniciarRodadaTVCinema() {
    ...
    function sortearPalavraTVCinema() {
        let numSorteio = Math.ceil(Math.random() * tvCinema.length);
...
function iniciarRodadaLugares() {
    ...
    function sortearPalavraLugares() {
        let numSorteio = Math.ceil(Math.random() * lugares.length);
...
function iniciarRodadaPessoas() {
    ...
    function sortearPalavraPessoas() {
        let numSorteio = Math.ceil(Math.random() * pessoas.length);
...
function iniciarRodadaEsportes() {
    ...
    function sortearPalavraEsportes() {
        let numSorteio = Math.ceil(Math.random() * esportes.length);
...
function iniciarRodadaProfissao() {
    ...
    function sortearPalavraProfissao() {
        let numSorteio = Math.ceil(Math.random() * profissao.length);
...
function iniciarRodadaAlimentos() {
    ...
    function sortearPalavraAlimentos() {
        let numSorteio = Math.ceil(Math.random() * alimentos.length);
...
function iniciarRodadaPersonagens() {
    ...
    function sortearPalavraPersonagens() {
        let numSorteio = Math.ceil(Math.random() * personagens.length);
...
function iniciarRodadaBiblico() {
    ...
    function sortearPalavraBiblico() {
        let numSorteio = Math.ceil(Math.random() * biblico.length);
